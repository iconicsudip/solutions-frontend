              ...
              <div className="sidebar-color">
                ...
                <div className="theme-color mb-2">
                  <ButtonContainer>
                    ...
                    <Button
                      className={`${sidenavColor === "#111" ? "border-2" : ""}`}
                      type="black"
                ...
                <div className="sidebarnav-color mb-2">
                  ...
                  <ButtonContainer className="trans">
                    <Button
                      type={
                        sidenavbarType === "transparent" ? "primary" : "white"
                      }
                      onClick={() => {
                    ...
                    <Button
                      type={sidenavbarType === "white" ? "primary" : "white"}
                      onClick={() => {
